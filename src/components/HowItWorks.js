        ...
        <div className={styles.steps}>
          <div className={styles.stepTextBox}>
            ...
            <p className={styles.stepDescription}>
              Sketch your signature with precision,ensuring personalized touch
          ...
          <div className={styles.stepTextBox}>
            ...
            <p className={styles.stepDescription}>
              Dive into a realm of customization with fonts and colors, creating
              a signature that stands out.
            </p>
          </div>
          ...
          <div className={styles.stepTextBox}>
            ...
            <p className={styles.stepDescription}>
              With a click, transform your masterpiece into a downloadable file.
              Own your signature in png format.
            </p>
          </div>
        </div>
      </section>
